...
//   });
//
//   ModelDataTwo.fromJson(Map<dynamic, dynamic> json) {
...
//   final int? quantity;
//
//   Saree({this.type, this.color, this.prize, this.quantity});
...
//   final int? quantity;
//
//   Western({this.type, this.color, this.prize, this.quantity});
